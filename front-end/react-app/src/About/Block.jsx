    ...
    <div className="flex flex-col md:flex-row bg-cat-secondary">
      ...
      <div className="w-full md:w-1/2 p-8 flex justify-center items-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold font-main text-cat-details mb-4">Mission Statement</h1>
          <p className="mb-8 text-cat-details font-main">
          ...
          <p className='text-cat-details font-main'>
