...
import Img from '../assets/blockkkk.png';
    ...
    <div className="flex flex-col md:flex-row bg-cat-primary">
      ...
      <div className="w-full md:w-1/2 p-8 flex justify-center items-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold font-main text-white mb-4">Mission Statement</h1>
          <p className="mb-8 text-white font-main">
