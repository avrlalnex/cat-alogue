    ...
    <div className="flex flex-col md:flex-row bg-cat-primary">
      <div className="w-full md:w-1/2 p-8 flex flex-col justify-center items-center md:items-start">
        <div className="text-center md:text-left"> 
          <h1 className="text-2xl font-bold text-white font-main text-white mb-4 mx-auto md:text-center">About Us</h1> 
          <p className="mb-8 text-center text-white font-main"> 
          ...
          <p className="text-center text-white font-main">
