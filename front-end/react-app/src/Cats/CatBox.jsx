...
const Catbox = (props) => {
    ...
    return ( 
        <div>
            ...
            <div className = "flex flex-col justify-center items-center h-76 w-64 bg-cat-secondary rounded-3xl m-10 ml-4 p-4">
            ...
            <h1 className = "text-2xl text-center text-cat-primary mt-4 h-2 mb-6">Luffy</h1>
