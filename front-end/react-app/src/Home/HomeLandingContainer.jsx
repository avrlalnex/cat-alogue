    ...
    <div>
      <div className="flex justify-between">
        ...
        <div className="w-1/2 p-8 flex flex-col justify-center">
          <h1 className="text-7xl mb-0 mt-24 text-white font-main text-left">Adopt, Don't Shop! </h1>
          <p className="text-lg mb-4 font-main text-white text-left font-normal">Your purrfect companion.</p>
          <button type='button' className="px-4 py-2 text-orange-500 bg-white border border-orange-500 rounded-xl hover:bg-orange-100 font-main focus:outline-none focus:ring w-32 mt-2 self-left">Adopt Now</button>
        </div>
