  ...
  return (
    <div className='bg-cat-secondary pb-10'>
      ...
      <div className="flex justify-center mt-6 ml-[-20px]">
        <a href="/signup"><button className="px-4 py-2 text-white bg-cat-primary rounded-xl font-main w-32 mr-4 hover:scale-105 transition duration-300"> Get Started </button></a>
