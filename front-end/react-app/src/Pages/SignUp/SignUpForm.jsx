...
const SignUpForm = () => {
  ...
  const handleSubmit = (event) => {
    ...
    .then(response => {console.log("success", response.data); window.location.href = '/login'})
      ...
      <img src={logo} alt="Catalogue Logo" className='mb-4 w-[30rem] h-[15rem]'/>
        ...
        <div className="bg-white p-8 border rounded-3xl shadow-lg">
          <form action="" onSubmit = {handleSubmit}>
            ...
            <div className="flex justify-center mb-4">
              <div className="w-84">
                <input role='input' type='text'placeholder='Email Address' className="w-96 px-4 py-2 border rounded-full border-cat-primary focus:outline-none focus:border-orange-600" name = "email_address" value = {formData.email_address} onChange = {handleChange} required/>
              </div>
            </div>

            <div className="flex justify-center mb-4">
              <div className="w-84">
                <input role='input' type='text'placeholder='Facebook Link' className="w-96 px-4 py-2 border rounded-full border-cat-primary focus:outline-none focus:border-orange-600" name = "email_address" value = {formData.email_address} onChange = {handleChange} required/>
              </div>
            </div>

            <div className="flex justify-center mb-4">
              <div className="w-84">
                <input role='input' type='text'placeholder='Home Address' className="w-96 px-4 py-2 border rounded-full border-cat-primary focus:outline-none focus:border-orange-600" name = "email_address" value = {formData.email_address} onChange = {handleChange} required/>
              </div>
            </div>
            ...
            <div className="flex justify-center mb-6">
              <button role='input' type='submit' className="px-4 py-2 text-white bg-cat-primary rounded-full hover:bg-orange-600 font-bold font-lilita focus:outline-none focus:ring w-32">Sign Up</button>
            </div>
          </form>
        </div>
