    ...
    <div className="flex justify-center items-center min-h-screen pb-12 bg-[#e6842c]">
      ...
      <img src={logo} alt="Catalogue Logo" className='mb-4 w-[30rem] h-[15rem]'/>
        ...
        <div className="text-center mt-12">
          ...
          <button type='button' className="px-4 py-2 text-orange-500 bg-white border border-orange-500 rounded-full hover:bg-orange-100 font-bold font-lilita focus:outline-none focus:ring w-32 mt-2">Sign in</button>
        </div>
      </div>
    </div>
  );
